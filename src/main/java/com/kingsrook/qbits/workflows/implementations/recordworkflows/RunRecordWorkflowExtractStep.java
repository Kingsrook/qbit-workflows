...
/*******************************************************************************
 ** Extract step for the run-record-workflow process.  Exists only to deal with
 ** this being a generic process (e.g., no table name defined in the meta data).
 ** Note:  copied from RunRecordScriptExtractStep
 *******************************************************************************/
public class RunRecordWorkflowExtractStep extends ExtractViaQueryStep
{
   ...
   public void preRun(RunBackendStepInput runBackendStepInput, RunBackendStepOutput runBackendStepOutput) throws QException
   {
      ...
      {
         runBackendStepOutput.addValue("workflowName", getOutput.getRecord().getValueString("name"));
      }
