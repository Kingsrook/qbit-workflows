...
public class WorkflowTypePossibleValueSource implements QCustomPossibleValueProvider<String>, MetaDataProducerInterface<QPossibleValueSource>
{
   ...
   public QPossibleValue<String> getPossibleValue(Serializable id)
   {
      ...
      return getPossibleValue(workflowType);
   }
    ...
    **
    ***************************************************************************/
   private static QPossibleValue<String> getPossibleValue(WorkflowType workflowType)
   {
      return new QPossibleValue<>(workflowType.getName(), workflowType.getLabel());
   }
